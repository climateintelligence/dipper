...
First activate the ``dipper`` Conda environment and install ``pytest``.
...
.. code-block:: console
  ...
  $ make clean
  $ make install
  $ conda list -n dipper --explicit > spec-file.txt
...
Make a new version of dipper in the following steps:
