#!/usr/bin/env python
#
# dipper documentation build configuration file, created by
...
# Add dipper to sys.path to avoid having to full
# install dipper for autodoc.
# Full install of dipper will burst memory limit on ReadTheDocs.
...
project = "dipper"
copyright = "2022, Jorgen Rosberg"
author = "Jorgen Rosberg"
...
version = dipper.__version__
# The full version, including alpha/beta/rc tags.
release = dipper.__version__
